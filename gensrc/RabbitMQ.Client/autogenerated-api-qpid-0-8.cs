...
namespace RabbitMQ.Client.Framing.v0_8qpid {
  ...
  public interface IChannelAlert: IMethod {
    ushort ReplyCode { get; }
    string ReplyText { get; }
    System.Collections.Generic.IDictionary<string, object> Details { get; }
  }
  ...
  public interface ITestTable: IMethod {
    System.Collections.Generic.IDictionary<string, object> Table { get; }
    byte IntegerOp { get; }
    byte StringOp { get; }
  }
...
namespace RabbitMQ.Client.Framing.Impl.v0_8qpid {
  ...
  public class ChannelAlert: RabbitMQ.Client.Impl.MethodBase, IChannelAlert {
    ...
    public ushort m_replyCode;
    public string m_replyText;
    public System.Collections.Generic.IDictionary<string, object> m_details;

    ushort IChannelAlert.ReplyCode { get { return m_replyCode; } }
    string IChannelAlert.ReplyText { get { return m_replyText; } }
    System.Collections.Generic.IDictionary<string, object> IChannelAlert.Details { get { return m_details; } }

    public ChannelAlert() {}
    public ChannelAlert(
      ushort initReplyCode,
      string initReplyText,
      System.Collections.Generic.IDictionary<string, object> initDetails)
    {
      m_replyCode = initReplyCode;
      m_replyText = initReplyText;
  ...
  public class TestTable: RabbitMQ.Client.Impl.MethodBase, ITestTable {
    ...
    public System.Collections.Generic.IDictionary<string, object> m_table;
    public byte m_integerOp;
    public byte m_stringOp;

    System.Collections.Generic.IDictionary<string, object> ITestTable.Table { get { return m_table; } }
    byte ITestTable.IntegerOp { get { return m_integerOp; } }
    byte ITestTable.StringOp { get { return m_stringOp; } }

    public TestTable() {}
    public TestTable(
      System.Collections.Generic.IDictionary<string, object> initTable,
      byte initIntegerOp,
      byte initStringOp)
    {
      m_table = initTable;
