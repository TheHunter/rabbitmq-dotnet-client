      ...
      switch (classId) {
        case 10: {
          switch (methodId) {
            ...
            case 60: {
              RabbitMQ.Client.Framing.Impl.v0_9_1.ConnectionBlocked result = new RabbitMQ.Client.Framing.Impl.v0_9_1.ConnectionBlocked();
              result.ReadArgumentsFrom(new RabbitMQ.Client.Impl.MethodArgumentReader(reader));
              return result;
            }
            case 61: {
              RabbitMQ.Client.Framing.Impl.v0_9_1.ConnectionUnblocked result = new RabbitMQ.Client.Framing.Impl.v0_9_1.ConnectionUnblocked();
              result.ReadArgumentsFrom(new RabbitMQ.Client.Impl.MethodArgumentReader(reader));
              return result;
            }
            default: break;
